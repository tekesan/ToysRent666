...
<html lang="en">
  ...
  <div class="site-wrap">
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="<?php echo base_url()?>">Home</a> <span class="mx-2 mb-0">/</span><strong class="text-black">Profile</strong></div>
        </div>
      </div>
    </div>  
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-6 profile-picture">
              <img src="https://tekesan.space/toysrent/assets/images/person.jpg" alt="Image" class="img-fluid">
          </div>
          <div class="col-md-6">
            <h2 class="text-black"><?= $profile->nama_lengkap ?></h2>
            <p><strong class="text-primary h4"><?= $profile->level.' | '.$profile->poin.' Points'?></strong></p>
            <div class="mb-4">
              <h6>Email: <?= $profile->email ?></h6>
              <h6>Date of Birth: <?= $profile->tanggal_lahir ?></h6>
              <h6>Phone Number: <?= $profile->no_telp ?></h6>
              <h6>Address: <?= $profile->jalan.' '.$profile->nomor.', '.$profile->kota.', '.$profile->kodepos?></h6>
            </div>

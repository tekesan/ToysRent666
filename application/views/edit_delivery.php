    ...
    <div class="site-section">
        ...
        <div class="container">
            <div class="row mb-5">
                ...
                <form id="formsell" name="formsell" method="post" class="col-md-12" action="<?=base_url('delivery-update')?>"
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="barang" required >
                                ...
                                <?php foreach ($all_barang as $s):?>
                                    <option  value="<?php echo $s->nama_item."|".$s->id_pemesanan; ?>"><?php echo $s->nama_item."|".$s->id_pemesanan; ?></option>
                                <?php endforeach; ?>
                            </select>
                        ...
                        <div class="form-group">
                            <input type="hidden" name="no_resi" value="<?php echo $all_barang[0]->no_resi?>">
                            <input class="form-control" type="text" name="alamat" value="<?php echo $all_barang[0]->nama_alamat_anggota; ?>" placeholder="Alamat tujuan" required>
                        </div>

                        <div class="form-group">
                            <input class="form-control" type="date" name="tanggal" value="<?php echo $all_barang[0]->tanggal; ?>"placeholder="Tanggal pengiriman" required>
                        </div>

                        <div class="form-group">
                            <input class="form-control" type="text" name="metode" value="<?php echo  $all_barang[0]->metode; ?>" placeholder="Metode" required>
                        </div>

                        <!--button class="btn btn-primary" type="button" data-toggle="modal" data-target="#myModal">Submit</button>-->

                        <button name="submit" type="submit" class="btn btn-danger btn-ok" value="Submit">Update!</button>
                </form>
